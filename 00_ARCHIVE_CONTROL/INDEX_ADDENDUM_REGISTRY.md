...
| `00_ARCHIVE_CONTROL/2026-08-25__index-addendum-three-horizon-action-compass-output-contract-v1.md` | DATA PING / RAW main-framework interpretation / three-horizon action compass | REGISTRY_DISCOVERABLE |
