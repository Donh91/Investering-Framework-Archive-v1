...
The non-parity monolithic file and both unintended paths are absent from the final branch diff. All 15 ordered archive parts match precomputed Git-blob SHA-1 values after remote readback.
