...
expected={"SHARED_ROW","CYCLE_NAVIGATOR","SHADOW_REGISTRY","MONTHLY_COUNCIL","SOURCE_RECOVERY","COMPOUNDING_LEARNING"}
...
for source in ("CYCLE_NAVIGATOR","SHADOW_REGISTRY","MONTHLY_COUNCIL","SOURCE_RECOVERY","COMPOUNDING_LEARNING"):
