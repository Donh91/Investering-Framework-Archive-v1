# Active Gate and Edge Event Registry — 2026-07-15T100211Z

**Status:** CANONICAL_RUNTIME_CONFIGURATION  
**Owner:** MAIN_FRAMEWORK / CHATGPT  
**Supersedes runtime state reviewed at:** 2026-07-15T10:03:26Z
...
ACTIVE_EDGE_EVENT:
  ...
  latest_material_update: 02_DATA_PING/live_state_handover/event_updates/2026-07-15T100211Z__rotation-repair-edge__medium-horizon-hold-short-horizon-cooling.md
```
...
BREADTH_STATUS: 1H_NEAR_NEUTRAL / 24H_BROAD / 7D_ABOVE_MAJORITY
...
```yaml
framework_acceptance_status_current_run: ACCEPTED_LOW_OBSERVABILITY_CONTINUATION_MEDIUM_HORIZON_HOLDS_SHORT_HORIZON_COOLS_NO_CLOSE_VERIFICATION_NO_UNLOCK
accepted_run_id: DATA_PING_V4_20260715T100211Z
accepted_predecessor_run_id: DATA_PING_V4_20260715T095102Z
...
The event remains open. Medium-horizon breadth and latest completed ETF evidence remain constructive, but short-horizon breadth cooled and the missing truth-layer close, hourly, taker and derivatives layers still block event closure or an entry-window decision.
