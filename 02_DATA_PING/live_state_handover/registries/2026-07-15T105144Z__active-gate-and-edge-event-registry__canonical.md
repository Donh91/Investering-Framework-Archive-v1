# Active Gate and Edge Event Registry — 2026-07-15T105144Z

**Status:** CANONICAL_RUNTIME_CONFIGURATION  
**Owner:** MAIN_FRAMEWORK / CHATGPT  
**Supersedes runtime state reviewed at:** 2026-07-15T10:33:39Z
...
ACTIVE_EDGE_EVENT:
  ...
  latest_framework_accepted_data_ping_id: DATA_PING_V4_20260715T105144Z
  latest_framework_review_time: 2026-07-15T14:06:09Z
  ...
  current_positive_evidence:
    ...
    - BREADTH_7D_68_6_PERCENT
    - BTC_ETF_2026_07_14_POSITIVE_181_1M
    - ETH_ETF_2026_07_14_POSITIVE_58_3M
    - ETH_ETF_3_5_7_10_SESSION_WINDOWS_POSITIVE
    - STABLECOIN_8_ASSET_PROXY_MARGINALLY_POSITIVE_LOW_CONFIDENCE
    - SUPPLEMENTAL_QA_IMPROVED_WITH_FIXED_COHORT_AND_CORE_DEX_OHLCV
  cooling_or_contradictory_evidence:
    - BREADTH_1H_WEAKENED_TO_31_4_PERCENT
    - BTC_ETF_3_5_7_10_SESSION_WINDOWS_NEGATIVE
    - ETHBTC_DERIVED_EASED_SLIGHTLY_CROSS_PING
  ...
  latest_material_update: 02_DATA_PING/live_state_handover/event_updates/2026-07-15T105144Z__rotation-repair-edge__medium-horizon-broad-short-horizon-weaker-supplemental-qa-improved.md
```
...
BREADTH_STATUS: 1H_WEAK / 24H_BROAD / 7D_NEAR_70_AND_ABOVE_MAJORITY
...
STABLECOIN_STATUS: COMPARABLE_8_ASSET_PROXY_MARGINALLY_POSITIVE / OFFICIAL_HISTORY_MISSING
DEX_STATUS: TWO_CORE_POOL_OHLCV_WINDOWS_ADDED / LOW_CONFIDENCE / NOT_NETWORK_TOTALS
...
```yaml
framework_acceptance_status_current_run: ACCEPTED_LOW_OBSERVABILITY_CONTINUATION_MEDIUM_HORIZON_BROAD_SHORT_HORIZON_WEAKENS_SUPPLEMENTAL_QA_IMPROVED_NO_CLOSE_VERIFICATION_NO_UNLOCK
accepted_run_id: DATA_PING_V4_20260715T105144Z
accepted_predecessor_run_id: DATA_PING_V4_20260715T100211Z
...
The event remains open. Medium-horizon breadth, the latest completed ETF session and limited supplemental QA remain constructive, but short-horizon breadth weakened and missing truth-layer close, hourly, taker and derivatives evidence still block event closure or an entry-window decision.
