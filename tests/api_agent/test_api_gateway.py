...
class ApiGatewayTests(unittest.TestCase):
    ...
    def test_valid_forecast_candidate(self):
        value=valid_output();value['forecast_candidates']=[{'metric_path':'market_metrics.BTC.close','direction':'UP','threshold':1.0,'range_low':None,'range_high':None,'horizon_days':7,'rationale':'test'}];validate_output(value)
