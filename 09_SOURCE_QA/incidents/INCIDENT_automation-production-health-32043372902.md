...
Status: **RED**
Generated: `2026-08-17T15:47:24.944369Z`
Workflows: 61 local / 66 registered
Scheduled: 25
Writers: 23
GREEN / AMBER / RED: 47 / 13 / 1

## Workflow matrix
| Workflow | Lifecycle | Schedule | Writer | Last conclusion | Last run | Status | Findings |
|---|---|---:|---:|---|---|---|---|
| `adaptive-decision-miss-validation.yml` | `ACTIVE` | yes | yes | success | 2026-08-16T22:52:17Z | **GREEN** | None |
| `adaptive-evidence-gap-gate.yml` | `ACTIVE` | no | no | success | 2026-08-15T14:20:05Z | **GREEN** | None |
| `adaptive-evidence-gap.yml` | `ACTIVE` | yes | yes | success | 2026-08-16T21:59:41Z | **GREEN** | None |
...
| `automation-production-health.yml` | `ACTIVE` | yes | yes | in_progress | 2026-08-17T15:47:15Z | **GREEN** | None |
...
| `backtest-wave1-4-prospective.yml` | `ACTIVE` | yes | no | success | 2026-08-16T15:51:02Z | **GREEN** | None |
...
| `continuity-learning-maintenance.yml` | `ACTIVE` | yes | yes | success | 2026-08-16T21:55:38Z | **AMBER** | RECOVERING_AFTER_RECENT_FAILURES |
| `daily-capture-architecture-gate.yml` | `ACTIVE` | no | no | success | 2026-08-16T10:31:03Z | **AMBER** | RECOVERING_AFTER_RECENT_FAILURES |
| `daily-director-shadow.yml` | `ACTIVE` | yes | yes | success | 2026-08-17T14:03:50Z | **GREEN** | None |
| `daily-raw-owner-capture.yml` | `ACTIVE` | yes | yes | success | 2026-08-17T13:55:29Z | **GREEN** | None |
| `daily-settled-etf-calibration.yml` | `ACTIVE` | yes | yes | success | 2026-08-17T07:12:03Z | **AMBER** | RECOVERING_AFTER_RECENT_FAILURES |
| `daily-stablecoin-liquidity.yml` | `ACTIVE` | yes | yes | success | 2026-08-17T05:54:29Z | **GREEN** | None |
...
| `ethbtc-persistence-lifecycle.yml` | `ACTIVE` | no | yes | success | 2026-08-17T14:05:07Z | **GREEN** | None |
...
| `evidence-lifecycle-store-health.yml` | `ACTIVE` | yes | no | success | 2026-08-17T04:03:54Z | **GREEN** | None |
...
| `framework-learning-operations.yml` | `ACTIVE` | yes | yes | success | 2026-08-17T02:34:46Z | **GREEN** | None |
| `full-architecture-1to7-gate.yml` | `ACTIVE` | no | no | success | 2026-08-16T11:33:59Z | **GREEN** | None |
| `hourly-sequence-capture.yml` | `ACTIVE` | yes | yes | success | 2026-08-17T10:16:29Z | **GREEN** | None |
...
| `master-monday-remaining-gaps.yml` | `ACTIVE` | yes | yes | success | 2026-08-17T07:43:24Z | **GREEN** | None |
...
| `operations-dashboard.yml` | `ACTIVE` | yes | yes | success | 2026-08-17T04:48:04Z | **GREEN** | None |
...
| `pdlt-daily-census.yml` | `ACTIVE` | yes | yes | success | 2026-08-16T22:00:41Z | **GREEN** | None |
| `pdlt-discovery-once.yml` | `EXPECTED_BLOCK` | no | no | failure | 2026-08-09T19:58:23Z | **AMBER** | EXPECTED_BLOCK |
| `pdlt-maturation.yml` | `ACTIVE` | yes | yes | success | 2026-08-16T22:41:25Z | **GREEN** | None |
...
| `remediation-maturation.yml` | `ACTIVE` | yes | yes | success | 2026-08-17T04:26:14Z | **GREEN** | None |
| `research-execution-coordinator.yml` | `ACTIVE` | yes | yes | failure | 2026-08-17T07:58:02Z | **RED** | LATEST_RUN_FAILED, REPEATED_CONSECUTIVE_FAILURES |
| `rich-breadth-checkpoint.yml` | `ACTIVE` | yes | yes | success | 2026-08-17T13:57:05Z | **GREEN** | None |
| `sequential-research-queue.yml` | `ACTIVE` | yes | yes | success | 2026-08-17T07:27:10Z | **GREEN** | None |
...
| `sunday-market-close-and-cfgi.yml` | `ACTIVE` | yes | yes | success | 2026-08-17T01:47:15Z | **AMBER** | RECOVERING_AFTER_RECENT_FAILURES |
...
| `weekly-api-calibration-shadow.yml` | `ACTIVE` | yes | yes | success | 2026-08-17T02:06:07Z | **AMBER** | RECOVERING_AFTER_RECENT_FAILURES |
| `weekly-raw-calibration-bridge.yml` | `ACTIVE` | yes | yes | success | 2026-08-17T01:59:35Z | **GREEN** | None |
| `weekly-sol-adversarial-review.yml` | `ACTIVE` | yes | yes | success | 2026-08-17T04:00:15Z | **GREEN** | None |
