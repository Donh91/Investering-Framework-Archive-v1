...
Status: **RED**
Generated: `2026-08-21T15:56:34.254306Z`
Workflows: 87 local / 92 registered
Scheduled: 31
Writers: 36
GREEN / AMBER / RED: 63 / 19 / 5
...
| `adaptive-rotation-cadence.yml` | `ACTIVE` | yes | yes | success | 2026-08-21T14:54:15Z | **AMBER** | RECOVERING_AFTER_RECENT_FAILURES |
...
| `automation-production-health.yml` | `ACTIVE` | yes | yes | in_progress | 2026-08-21T15:56:21Z | **GREEN** | None |
...
| `cfgi-recovery-launch-once.yml` | `ACTIVE` | yes | no | success | 2026-08-21T15:40:22Z | **AMBER** | SCHEDULE_WITHOUT_EXPLICIT_TIMEZONE |
| `cfgi-recovery-launch-trigger.yml` | `ACTIVE` | no | yes | skipped | 2026-08-21T15:10:14Z | **GREEN** | None |
| `cfgi-v3-launch-receipt-publish.yml` | `ACTIVE` | no | yes | success | 2026-08-21T15:40:36Z | **GREEN** | None |
...
| `daily-director-shadow.yml` | `ACTIVE` | yes | yes | success | 2026-08-21T14:09:44Z | **GREEN** | None |
| `daily-raw-owner-capture.yml` | `ACTIVE` | yes | yes | success | 2026-08-21T13:09:20Z | **GREEN** | None |
...
| `data-architecture-gate.yml` | `ACTIVE` | no | no | success | 2026-08-21T15:26:52Z | **GREEN** | None |
...
| `entry-signal-ledger.yml` | `ACTIVE` | yes | yes | success | 2026-08-21T15:18:09Z | **GREEN** | None |
| `ethbtc-persistence-lifecycle.yml` | `ACTIVE` | no | yes | success | 2026-08-21T14:10:37Z | **GREEN** | None |
...
| `historical-altseason-cfgi-enrichment.yml` | `ACTIVE` | no | no | failure | 2026-08-21T14:28:10Z | **RED** | REPEATED_CONSECUTIVE_FAILURES |
...
| `hourly-sequence-capture.yml` | `ACTIVE` | yes | yes | success | 2026-08-21T10:21:36Z | **GREEN** | None |
| `intraday-execution-gate.yml` | `ACTIVE` | no | no | success | 2026-08-20T20:04:47Z | **GREEN** | None |
| `intraday-execution-research.yml` | `ACTIVE` | yes | yes | failure | 2026-08-21T15:24:21Z | **RED** | LATEST_RUN_FAILED, REPEATED_CONSECUTIVE_FAILURES, SCHEDULE_WITHOUT_EXPLICIT_TIMEZONE |
...
| `operations-dashboard.yml` | `ACTIVE` | yes | yes | success | 2026-08-21T04:42:27Z | **GREEN** | None |
...
| `pullback-learning-ledger.yml` | `ACTIVE` | yes | yes | success | 2026-08-21T15:18:46Z | **GREEN** | None |
| `remediation-maturation-gate.yml` | `ACTIVE` | no | no | success | 2026-08-10T20:05:49Z | **AMBER** | RECOVERING_AFTER_RECENT_FAILURES |
| `remediation-maturation.yml` | `ACTIVE` | yes | yes | success | 2026-08-21T04:23:53Z | **GREEN** | None |
| `research-execution-coordinator.yml` | `ACTIVE` | yes | yes | failure | 2026-08-21T07:52:47Z | **RED** | LATEST_RUN_FAILED, REPEATED_CONSECUTIVE_FAILURES |
| `rich-breadth-checkpoint.yml` | `ACTIVE` | yes | yes | success | 2026-08-21T13:15:17Z | **GREEN** | None |
| `sequential-research-queue.yml` | `ACTIVE` | yes | yes | success | 2026-08-21T07:12:23Z | **GREEN** | None |
| `shadow-registry-gate.yml` | `ACTIVE` | no | no | success | 2026-08-21T15:26:52Z | **GREEN** | None |
...
| `storage-health-gate.yml` | `ACTIVE` | no | no | success | 2026-08-21T15:26:52Z | **GREEN** | None |
