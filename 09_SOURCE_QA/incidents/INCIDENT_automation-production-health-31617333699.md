...
Status: **RED**
Generated: `2026-08-12T16:23:45.531447Z`
Workflows: 50 local / 55 registered
Scheduled: 19
Writers: 17
GREEN / AMBER / RED: 35 / 14 / 1
...
| `automation-production-health.yml` | `ACTIVE` | yes | yes | in_progress | 2026-08-12T16:23:37Z | **GREEN** | None |
...
| `backtest-wave1-4-prospective.yml` | `ACTIVE` | yes | no | success | 2026-08-11T16:28:22Z | **GREEN** | None |
...
| `continuity-learning-maintenance.yml` | `ACTIVE` | yes | yes | success | 2026-08-11T22:23:52Z | **GREEN** | None |
| `daily-capture-architecture-gate.yml` | `ACTIVE` | no | no | success | 2026-08-12T03:54:58Z | **AMBER** | RECOVERING_AFTER_RECENT_FAILURES |
| `daily-director-shadow.yml` | `ACTIVE` | yes | yes | success | 2026-08-11T22:08:50Z | **GREEN** | None |
| `daily-raw-owner-capture.yml` | `ACTIVE` | yes | yes | success | 2026-08-12T14:33:15Z | **GREEN** | None |
| `daily-settled-etf-calibration.yml` | `ACTIVE` | yes | yes | success | 2026-08-12T07:46:35Z | **AMBER** | RECOVERING_AFTER_RECENT_FAILURES |
...
| `framework-learning-operations.yml` | `ACTIVE` | yes | yes | success | 2026-08-12T03:30:29Z | **GREEN** | None |
| `full-architecture-1to7-gate.yml` | `ACTIVE` | no | no | success | 2026-08-12T06:30:47Z | **GREEN** | None |
| `hourly-sequence-capture.yml` | `ACTIVE` | yes | yes | success | 2026-08-12T10:45:16Z | **GREEN** | None |
...
| `operations-dashboard.yml` | `ACTIVE` | yes | yes | success | 2026-08-12T05:40:33Z | **GREEN** | None |
...
| `pdlt-daily-census.yml` | `ACTIVE` | yes | yes | success | 2026-08-11T22:27:20Z | **GREEN** | None |
| `pdlt-discovery-once.yml` | `EXPECTED_BLOCK` | no | no | failure | 2026-08-09T19:58:23Z | **AMBER** | EXPECTED_BLOCK |
| `pdlt-maturation.yml` | `ACTIVE` | yes | yes | success | 2026-08-11T23:07:44Z | **GREEN** | None |
...
| `remediation-maturation.yml` | `ACTIVE` | yes | yes | success | 2026-08-12T05:18:51Z | **GREEN** | None |
| `research-execution-coordinator.yml` | `ACTIVE` | yes | yes | failure | 2026-08-12T08:36:41Z | **RED** | LATEST_RUN_FAILED |
| `sequential-research-queue.yml` | `ACTIVE` | yes | yes | success | 2026-08-12T07:56:35Z | **GREEN** | None |
