...
Status: **RED**
Generated: `2026-08-23T15:44:02.652200Z`
Workflows: 108 local / 100 registered
Scheduled: 40
Writers: 46
GREEN / AMBER / RED: 75 / 29 / 4
...
| `adaptive-rotation-cadence.yml` | `ACTIVE` | yes | yes | success | 2026-08-23T14:41:01Z | **GREEN** | None |
| `api-agent-gateway-gate.yml` | `ACTIVE` | no | no | success | 2026-08-23T15:24:40Z | **GREEN** | None |
| `automation-production-health-gate.yml` | `ACTIVE` | no | no | success | 2026-08-23T15:41:55Z | **AMBER** | RECOVERING_AFTER_RECENT_FAILURES |
| `automation-production-health.yml` | `ACTIVE` | yes | yes | in_progress | 2026-08-23T15:43:55Z | **GREEN** | None |
...
| `buildwithclaude-shadow-evidence-ledger.yml` | `ACTIVE` | yes | yes | none | none | **AMBER** | NO_RUN_HISTORY |
| `buildwithclaude-shadow-prospective-observer.yml` | `ACTIVE` | no | no | success | 2026-08-23T15:24:40Z | **GREEN** | None |
| `buildwithclaude-shadow-round1.yml` | `ACTIVE` | no | no | success | 2026-08-23T15:24:40Z | **AMBER** | RECOVERING_AFTER_RECENT_FAILURES |
| `cfgi-recovery-launch-once.yml` | `ACTIVE` | no | no | success | 2026-08-23T07:25:36Z | **GREEN** | None |
| `cfgi-recovery-launch-trigger.yml` | `ACTIVE` | no | yes | skipped | 2026-08-23T15:42:08Z | **GREEN** | None |
...
| `continuity-learning-gate.yml` | `ACTIVE` | no | no | success | 2026-08-23T15:24:40Z | **GREEN** | None |
...
| `daily-capture-architecture-gate.yml` | `ACTIVE` | no | no | failure | 2026-08-23T15:24:40Z | **RED** | REPEATED_CONSECUTIVE_FAILURES |
| `daily-director-shadow.yml` | `ACTIVE` | yes | yes | success | 2026-08-23T13:56:57Z | **GREEN** | None |
| `daily-raw-owner-capture.yml` | `ACTIVE` | yes | yes | success | 2026-08-23T13:00:16Z | **GREEN** | None |
...
| `data-architecture-gate.yml` | `ACTIVE` | no | no | queued | 2026-08-23T15:44:12Z | **GREEN** | None |
...
| `entry-signal-ledger.yml` | `ACTIVE` | yes | yes | success | 2026-08-23T15:07:30Z | **GREEN** | None |
| `ethbtc-persistence-lifecycle.yml` | `ACTIVE` | no | yes | success | 2026-08-23T13:58:13Z | **GREEN** | None |
...
| `full-architecture-1to7-gate.yml` | `ACTIVE` | no | no | in_progress | 2026-08-23T15:44:12Z | **GREEN** | None |
...
| `hourly-sequence-capture.yml` | `ACTIVE` | yes | yes | success | 2026-08-23T10:15:53Z | **GREEN** | None |
| `intraday-execution-gate.yml` | `ACTIVE` | no | no | success | 2026-08-20T20:04:47Z | **GREEN** | None |
| `intraday-execution-research.yml` | `ACTIVE` | yes | yes | failure | 2026-08-23T15:13:43Z | **RED** | LATEST_RUN_FAILED, REPEATED_CONSECUTIVE_FAILURES, SCHEDULE_WITHOUT_EXPLICIT_TIMEZONE |
...
| `operations-dashboard.yml` | `ACTIVE` | yes | yes | success | 2026-08-23T04:41:47Z | **GREEN** | None |
...
| `pullback-learning-ledger.yml` | `ACTIVE` | yes | yes | success | 2026-08-23T15:08:33Z | **GREEN** | None |
| `remediation-maturation-gate.yml` | `ACTIVE` | no | no | success | 2026-08-22T13:30:18Z | **AMBER** | RECOVERING_AFTER_RECENT_FAILURES |
| `remediation-maturation.yml` | `ACTIVE` | yes | yes | success | 2026-08-23T08:18:39Z | **GREEN** | None |
| `research-execution-coordinator.yml` | `ACTIVE` | yes | yes | failure | 2026-08-23T07:43:05Z | **RED** | LATEST_RUN_FAILED, REPEATED_CONSECUTIVE_FAILURES |
...
| `rich-breadth-checkpoint.yml` | `ACTIVE` | yes | yes | success | 2026-08-23T13:05:40Z | **GREEN** | None |
...
| `shadow-admission-ai-decider.yml` | `ACTIVE` | yes | yes | success | 2026-08-23T15:24:40Z | **GREEN** | None |
...
- REGISTERED_WITHOUT_LOCAL_FILE:phase4-no-hindsight-replay.yml
...
- buildwithclaude-shadow-evidence-ledger.yml:NO_RUN_HISTORY
