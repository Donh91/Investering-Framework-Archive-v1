...
Status: **RED**
Generated: `2026-09-13T18:16:27.651416Z`
Workflows: 137 local / 149 registered
Scheduled: 46
Writers: 52
GREEN / AMBER / RED: 109 / 23 / 5
...
| `adaptive-rotation-cadence.yml` | `ACTIVE` | yes | yes | success | 2026-09-13T14:24:19Z | **GREEN** | None |
| `api-agent-gateway-gate.yml` | `ACTIVE` | no | no | success | 2026-09-13T11:48:48Z | **GREEN** | None |
| `astra-landing-zone-gate.yml` | `ACTIVE` | no | no | success | 2026-09-13T09:52:24Z | **GREEN** | None |
| `automation-production-health-gate.yml` | `ACTIVE` | no | no | success | 2026-09-13T17:21:21Z | **AMBER** | RECOVERING_AFTER_RECENT_FAILURES |
| `automation-production-health.yml` | `ACTIVE` | yes | yes | in_progress | 2026-09-13T18:16:16Z | **GREEN** | None |
| `autonomous-research-governance-gate.yml` | `ACTIVE` | no | no | success | 2026-09-13T09:58:52Z | **GREEN** | None |
| `autonomous-research-governance-loop.yml` | `ACTIVE` | yes | yes | success | 2026-09-13T10:24:16Z | **GREEN** | None |
...
| `cfgi-recovery-launch-trigger.yml` | `ACTIVE` | no | yes | skipped | 2026-09-13T16:05:34Z | **GREEN** | None |
| `cfgi-v3-launch-receipt-publish.yml` | `ACTIVE` | no | yes | success | 2026-08-23T07:24:14Z | **GREEN** | None |
| `codex-intake-dispatch.yml` | `ACTIVE` | no | no | success | 2026-09-13T17:22:09Z | **GREEN** | None |
| `continuity-learning-gate.yml` | `ACTIVE` | no | no | success | 2026-09-13T11:48:48Z | **GREEN** | None |
...
| `cross-repo-agent-context-gate.yml` | `ACTIVE` | no | no | success | 2026-09-13T09:58:52Z | **GREEN** | None |
...
| `cycle-navigator-pages.yml` | `ACTIVE` | no | no | success | 2026-09-13T14:51:11Z | **GREEN** | None |
| `cycle-navigator-weekly-publication.yml` | `ACTIVE` | yes | yes | success | 2026-09-07T13:27:30Z | **GREEN** | None |
| `daily-capture-architecture-gate.yml` | `ACTIVE` | no | no | success | 2026-09-13T11:07:46Z | **GREEN** | None |
| `daily-director-shadow.yml` | `ACTIVE` | yes | yes | success | 2026-09-13T17:03:07Z | **GREEN** | None |
...
| `daily-raw-owner-capture.yml` | `ACTIVE` | yes | yes | success | 2026-09-13T16:14:12Z | **GREEN** | None |
| `daily-settled-etf-calibration.yml` | `ACTIVE` | yes | yes | success | 2026-09-13T11:41:46Z | **GREEN** | None |
| `daily-slow-cycle-shadow.yml` | `ACTIVE` | yes | yes | success | 2026-09-13T09:42:02Z | **AMBER** | RECOVERING_AFTER_RECENT_FAILURES |
| `daily-stablecoin-liquidity.yml` | `ACTIVE` | yes | yes | success | 2026-09-13T10:22:56Z | **GREEN** | None |
| `data-architecture-gate.yml` | `ACTIVE` | no | no | success | 2026-09-13T17:21:21Z | **GREEN** | None |
...
| `entry-signal-ledger.yml` | `ACTIVE` | yes | yes | success | 2026-09-13T16:39:46Z | **AMBER** | RECOVERING_AFTER_RECENT_FAILURES |
| `ethbtc-persistence-lifecycle.yml` | `ACTIVE` | no | yes | success | 2026-09-13T17:04:09Z | **GREEN** | None |
...
| `experiment-lifecycle-gate.yml` | `ACTIVE` | no | no | success | 2026-09-13T14:17:38Z | **GREEN** | None |
| `external-alpha-registry-gate.yml` | `ACTIVE` | yes | no | none | none | **AMBER** | NO_RUN_HISTORY, SCHEDULE_WITHOUT_EXPLICIT_TIMEZONE |
...
| `full-architecture-1to7-gate.yml` | `ACTIVE` | no | no | success | 2026-09-13T16:05:14Z | **GREEN** | None |
...
| `hourly-sequence-capture.yml` | `ACTIVE` | yes | yes | success | 2026-09-13T16:08:41Z | **AMBER** | RECOVERING_AFTER_RECENT_FAILURES |
| `intraday-execution-gate.yml` | `ACTIVE` | no | no | success | 2026-09-13T10:54:28Z | **AMBER** | RECOVERING_AFTER_RECENT_FAILURES |
...
| `meme-alpha-runtime-gate.yml` | `ACTIVE` | no | no | success | 2026-09-13T11:44:39Z | **GREEN** | None |
...
| `monthly-ai-learning-council.yml` | `ACTIVE` | yes | yes | success | 2026-09-13T09:33:44Z | **GREEN** | None |
| `native-handlekompas.yml` | `ACTIVE` | yes | yes | success | 2026-09-13T16:39:56Z | **GREEN** | None |
| `native-market-recovery.yml` | `ACTIVE` | yes | yes | success | 2026-09-13T17:35:39Z | **GREEN** | None |
...
| `operations-dashboard.yml` | `ACTIVE` | yes | yes | success | 2026-09-13T09:18:55Z | **GREEN** | None |
| `operations-recovery-launch-once.yml` | `ACTIVE` | no | no | success | 2026-08-31T16:26:39Z | **GREEN** | None |
| `owner-bound-daily-director-manual.yml` | `ACTIVE` | no | no | success | 2026-09-13T11:48:48Z | **GREEN** | None |
...
| `provider-budget-readback.yml` | `ACTIVE` | no | yes | success | 2026-09-13T16:14:47Z | **GREEN** | None |
| `pullback-learning-gate.yml` | `ACTIVE` | no | no | failure | 2026-09-13T09:52:24Z | **RED** | REPEATED_CONSECUTIVE_FAILURES |
| `pullback-learning-ledger.yml` | `ACTIVE` | yes | yes | cancelled | 2026-09-13T16:39:51Z | **RED** | LATEST_RUN_FAILED |
| `remediation-maturation-gate.yml` | `ACTIVE` | no | no | success | 2026-09-13T17:17:30Z | **GREEN** | None |
| `remediation-maturation.yml` | `ACTIVE` | yes | yes | success | 2026-09-13T17:22:14Z | **GREEN** | None |
| `research-execution-coordinator.yml` | `ACTIVE` | yes | yes | success | 2026-09-13T12:41:30Z | **GREEN** | None |
| `research-owner-breadth-daily.yml` | `ACTIVE` | yes | yes | success | 2026-09-13T10:18:06Z | **GREEN** | None |
| `research-owner-btcd-daily.yml` | `ACTIVE` | yes | yes | success | 2026-09-13T10:35:02Z | **GREEN** | None |
| `rich-breadth-checkpoint.yml` | `ACTIVE` | yes | yes | success | 2026-09-13T13:20:44Z | **GREEN** | None |
...
| `sequential-research-queue.yml` | `ACTIVE` | yes | yes | success | 2026-09-13T12:04:16Z | **GREEN** | None |
...
| `shared-row-prospective-evidence-loop.yml` | `ACTIVE` | yes | yes | success | 2026-09-13T14:42:36Z | **GREEN** | None |
...
| `situation-room-daily-static.yml` | `ACTIVE` | yes | yes | success | 2026-09-13T11:53:07Z | **GREEN** | None |
| `situation-room-owner-live-gate.yml` | `ACTIVE` | no | no | success | 2026-09-01T16:30:25Z | **AMBER** | RECOVERING_AFTER_RECENT_FAILURES |
| `situation-room-shadow-bridge.yml` | `ACTIVE` | yes | yes | failure | 2026-09-13T12:14:28Z | **RED** | LATEST_RUN_FAILED, REPEATED_CONSECUTIVE_FAILURES |
| `source-provenance-recovery-gate.yml` | `ACTIVE` | no | no | success | 2026-08-23T11:29:50Z | **GREEN** | None |
| `source-provenance-recovery-loop.yml` | `ACTIVE` | yes | yes | success | 2026-09-13T10:05:00Z | **GREEN** | None |
| `specialist-architecture-gate.yml` | `ACTIVE` | no | no | success | 2026-08-23T11:29:50Z | **GREEN** | None |
| `storage-health-gate.yml` | `ACTIVE` | no | no | success | 2026-09-13T17:21:21Z | **GREEN** | None |
...
- intraday-execution-gate.yml:RECOVERING_AFTER_RECENT_FAILURES
