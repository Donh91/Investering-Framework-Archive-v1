...
Status: **RED**
Generated: `2026-08-28T15:31:21.960497Z`
Workflows: 114 local / 121 registered
Scheduled: 43
Writers: 49
GREEN / AMBER / RED: 83 / 27 / 4
...
| `automation-production-health-gate.yml` | `ACTIVE` | no | no | success | 2026-08-28T06:00:52Z | **GREEN** | None |
| `automation-production-health.yml` | `ACTIVE` | yes | yes | in_progress | 2026-08-28T15:31:08Z | **GREEN** | None |
| `autonomous-research-governance-gate.yml` | `ACTIVE` | no | no | success | 2026-08-23T11:29:50Z | **GREEN** | None |
| `autonomous-research-governance-loop.yml` | `ACTIVE` | yes | yes | success | 2026-08-27T16:36:11Z | **AMBER** | SCHEDULE_STALE |
...
| `backtest-wave1-4-prospective.yml` | `ACTIVE` | yes | no | success | 2026-08-28T00:33:58Z | **GREEN** | None |
...
| `cfgi-recovery-launch-trigger.yml` | `ACTIVE` | no | yes | skipped | 2026-08-28T05:15:22Z | **GREEN** | None |
...
| `daily-director-shadow.yml` | `ACTIVE` | yes | yes | failure | 2026-08-28T11:51:48Z | **RED** | LATEST_RUN_FAILED, REPEATED_CONSECUTIVE_FAILURES, SCHEDULE_STALE |
| `daily-raw-owner-capture.yml` | `ACTIVE` | yes | yes | success | 2026-08-28T11:24:08Z | **GREEN** | None |
| `daily-settled-etf-calibration.yml` | `ACTIVE` | yes | yes | success | 2026-08-27T17:35:07Z | **AMBER** | SCHEDULE_STALE |
| `daily-slow-cycle-shadow.yml` | `ACTIVE` | yes | yes | none | none | **AMBER** | NO_RUN_HISTORY |
| `daily-stablecoin-liquidity.yml` | `ACTIVE` | yes | yes | success | 2026-08-27T16:34:28Z | **AMBER** | SCHEDULE_STALE |
| `data-architecture-gate.yml` | `ACTIVE` | no | no | success | 2026-08-28T06:00:52Z | **GREEN** | None |
...
| `entry-signal-ledger.yml` | `ACTIVE` | yes | yes | failure | 2026-08-28T07:06:58Z | **RED** | LATEST_RUN_FAILED, SCHEDULE_STALE |
...
| `full-architecture-1to7-gate.yml` | `ACTIVE` | no | no | success | 2026-08-28T05:15:07Z | **GREEN** | None |
...
| `hourly-sequence-capture.yml` | `ACTIVE` | yes | yes | success | 2026-08-28T00:41:54Z | **AMBER** | SCHEDULE_STALE |
| `intraday-execution-gate.yml` | `ACTIVE` | no | no | success | 2026-08-24T05:51:40Z | **GREEN** | None |
| `intraday-execution-research.yml` | `ACTIVE` | yes | yes | success | 2026-08-28T08:09:12Z | **AMBER** | SCHEDULE_STALE, SCHEDULE_WITHOUT_EXPLICIT_TIMEZONE |
...
| `operations-dashboard.yml` | `ACTIVE` | yes | yes | success | 2026-08-28T00:45:06Z | **AMBER** | SCHEDULE_STALE |
...
| `pullback-learning-ledger.yml` | `ACTIVE` | yes | yes | failure | 2026-08-28T07:07:13Z | **RED** | LATEST_RUN_FAILED, SCHEDULE_STALE |
| `remediation-maturation-gate.yml` | `ACTIVE` | no | no | success | 2026-08-22T13:30:18Z | **AMBER** | RECOVERING_AFTER_RECENT_FAILURES |
| `remediation-maturation.yml` | `ACTIVE` | yes | yes | success | 2026-08-28T06:01:07Z | **AMBER** | SCHEDULE_STALE |
| `research-execution-coordinator.yml` | `ACTIVE` | yes | yes | success | 2026-08-28T03:32:49Z | **AMBER** | RECOVERING_AFTER_RECENT_FAILURES, SCHEDULE_STALE |
| `research-owner-breadth-daily.yml` | `ACTIVE` | yes | yes | success | 2026-08-27T16:31:25Z | **AMBER** | SCHEDULE_STALE |
| `research-owner-btcd-daily.yml` | `ACTIVE` | yes | yes | success | 2026-08-27T16:46:29Z | **AMBER** | SCHEDULE_STALE |
| `rich-breadth-checkpoint.yml` | `ACTIVE` | yes | yes | success | 2026-08-28T11:30:57Z | **GREEN** | None |
...
| `sequential-research-queue.yml` | `ACTIVE` | yes | yes | success | 2026-08-27T17:41:40Z | **AMBER** | SCHEDULE_STALE |
...
| `shared-row-prospective-evidence-loop.yml` | `ACTIVE` | yes | yes | success | 2026-08-28T01:09:54Z | **AMBER** | SCHEDULE_STALE |
...
| `situation-room-daily-static.yml` | `ACTIVE` | yes | yes | cancelled | 2026-08-27T17:38:18Z | **RED** | LATEST_RUN_FAILED, SCHEDULE_STALE |
...
| `source-provenance-recovery-loop.yml` | `ACTIVE` | yes | yes | success | 2026-08-27T16:17:37Z | **AMBER** | SCHEDULE_STALE |
| `specialist-architecture-gate.yml` | `ACTIVE` | no | no | success | 2026-08-23T11:29:50Z | **GREEN** | None |
| `storage-health-gate.yml` | `ACTIVE` | no | no | success | 2026-08-28T06:00:52Z | **GREEN** | None |
...
- pullback-learning-ledger.yml:SCHEDULE_STALE
...
- intraday-execution-research.yml:SCHEDULE_STALE
...
- research-execution-coordinator.yml:SCHEDULE_STALE
- research-owner-breadth-daily.yml:SCHEDULE_STALE
- research-owner-btcd-daily.yml:SCHEDULE_STALE
- sequential-research-queue.yml:SCHEDULE_STALE
- shared-row-prospective-evidence-loop.yml:SCHEDULE_STALE
- situation-room-owner-live-gate.yml:RECOVERING_AFTER_RECENT_FAILURES
- source-provenance-recovery-loop.yml:SCHEDULE_STALE
