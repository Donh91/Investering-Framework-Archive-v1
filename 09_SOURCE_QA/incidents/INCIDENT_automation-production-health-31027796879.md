...
Status: **RED**
Generated: `2026-08-05T16:58:31.722686Z`
Workflows: 40 local / 43 registered
Scheduled: 12
Writers: 11
GREEN / AMBER / RED: 29 / 7 / 4

## Workflow matrix
| Workflow | Schedule | Writer | Last conclusion | Last run | Status | Findings |
|---|---:|---:|---|---|---|---|
| `api-agent-gateway-gate.yml` | no | no | success | 2026-08-05T11:24:56Z | **AMBER** | RECOVERING_AFTER_RECENT_FAILURES |
| `automation-production-health-gate.yml` | no | no | success | 2026-08-05T15:35:53Z | **GREEN** | None |
| `automation-production-health.yml` | yes | yes | in_progress | 2026-08-05T16:58:18Z | **RED** | REPEATED_CONSECUTIVE_FAILURES |
...
| `backtest-wave1-4-prospective.yml` | yes | no | success | 2026-08-05T15:35:53Z | **GREEN** | None |
...
| `continuity-learning-gate.yml` | no | no | success | 2026-08-05T15:35:53Z | **GREEN** | None |
...
| `daily-raw-owner-capture.yml` | yes | yes | success | 2026-08-05T15:32:18Z | **GREEN** | None |
| `data-architecture-gate.yml` | no | no | success | 2026-08-05T15:35:53Z | **GREEN** | None |
...
| `full-architecture-1to7-gate.yml` | no | no | success | 2026-08-05T15:35:53Z | **GREEN** | None |
...
| `operations-dashboard.yml` | yes | yes | success | 2026-08-05T06:32:21Z | **GREEN** | None |
| `owner-bound-daily-director-manual.yml` | no | no | success | 2026-08-05T11:24:55Z | **GREEN** | None |
| `pdf-inspector-ingestion.yml` | no | no | success | 2026-08-02T18:16:02Z | **GREEN** | None |
| `remediation-maturation-gate.yml` | no | no | success | 2026-08-05T15:35:53Z | **GREEN** | None |
| `remediation-maturation.yml` | yes | yes | none | none | **AMBER** | NO_RUN_HISTORY |
| `specialist-architecture-gate.yml` | no | no | success | 2026-08-01T05:33:29Z | **GREEN** | None |
| `storage-health-gate.yml` | no | no | success | 2026-08-05T15:35:53Z | **GREEN** | None |
