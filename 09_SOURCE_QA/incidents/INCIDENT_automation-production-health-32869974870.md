...
Status: **RED**
Generated: `2026-08-25T16:07:36.165868Z`
Workflows: 112 local / 100 registered
Scheduled: 42
Writers: 48
GREEN / AMBER / RED: 78 / 32 / 2
...
| `adaptive-rotation-cadence.yml` | `ACTIVE` | yes | yes | success | 2026-08-25T15:06:41Z | **GREEN** | None |
| `api-agent-gateway-gate.yml` | `ACTIVE` | no | no | failure | 2026-08-25T05:37:19Z | **RED** | REPEATED_CONSECUTIVE_FAILURES |
| `automation-production-health-gate.yml` | `ACTIVE` | no | no | success | 2026-08-25T12:29:16Z | **GREEN** | None |
| `automation-production-health.yml` | `ACTIVE` | yes | yes | in_progress | 2026-08-25T16:06:50Z | **GREEN** | None |
...
| `cfgi-recovery-launch-trigger.yml` | `ACTIVE` | no | yes | skipped | 2026-08-25T12:29:31Z | **GREEN** | None |
...
| `continuity-learning-gate.yml` | `ACTIVE` | no | no | success | 2026-08-25T05:37:19Z | **GREEN** | None |
...
| `daily-capture-architecture-gate.yml` | `ACTIVE` | no | no | success | 2026-08-25T05:37:19Z | **GREEN** | None |
| `daily-director-shadow.yml` | `ACTIVE` | yes | yes | success | 2026-08-25T14:24:04Z | **GREEN** | None |
| `daily-raw-owner-capture.yml` | `ACTIVE` | yes | yes | success | 2026-08-25T13:09:34Z | **GREEN** | None |
...
| `data-architecture-gate.yml` | `ACTIVE` | no | no | success | 2026-08-25T12:29:15Z | **GREEN** | None |
...
| `entry-signal-ledger.yml` | `ACTIVE` | yes | yes | success | 2026-08-25T15:29:23Z | **GREEN** | None |
| `ethbtc-persistence-lifecycle.yml` | `ACTIVE` | no | yes | success | 2026-08-25T14:25:06Z | **GREEN** | None |
...
| `full-architecture-1to7-gate.yml` | `ACTIVE` | no | no | success | 2026-08-25T12:29:15Z | **GREEN** | None |
...
| `hourly-sequence-capture.yml` | `ACTIVE` | yes | yes | success | 2026-08-25T10:23:40Z | **GREEN** | None |
| `intraday-execution-gate.yml` | `ACTIVE` | no | no | success | 2026-08-24T05:51:40Z | **GREEN** | None |
| `intraday-execution-research.yml` | `ACTIVE` | yes | yes | success | 2026-08-25T15:34:29Z | **AMBER** | SCHEDULE_WITHOUT_EXPLICIT_TIMEZONE |
...
| `operations-dashboard.yml` | `ACTIVE` | yes | yes | success | 2026-08-25T04:43:02Z | **GREEN** | None |
...
| `pullback-learning-ledger.yml` | `ACTIVE` | yes | yes | success | 2026-08-25T15:29:42Z | **GREEN** | None |
| `remediation-maturation-gate.yml` | `ACTIVE` | no | no | success | 2026-08-22T13:30:18Z | **AMBER** | RECOVERING_AFTER_RECENT_FAILURES |
| `remediation-maturation.yml` | `ACTIVE` | yes | yes | success | 2026-08-25T05:40:12Z | **GREEN** | None |
| `research-execution-coordinator.yml` | `ACTIVE` | yes | yes | success | 2026-08-25T07:53:46Z | **AMBER** | RECOVERING_AFTER_RECENT_FAILURES |
...
| `rich-breadth-checkpoint.yml` | `ACTIVE` | yes | yes | success | 2026-08-25T13:16:01Z | **GREEN** | None |
