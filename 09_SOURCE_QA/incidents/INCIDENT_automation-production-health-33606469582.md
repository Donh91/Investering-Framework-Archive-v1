...
Status: **RED**
Generated: `2026-09-02T08:01:00.958862Z`
Workflows: 117 local / 124 registered
Scheduled: 43
Writers: 50
GREEN / AMBER / RED: 98 / 17 / 2

## Workflow matrix
| Workflow | Lifecycle | Schedule | Writer | Last conclusion | Last run | Status | Findings |
|---|---|---:|---:|---|---|---|---|
| `adaptive-decision-miss-validation.yml` | `ACTIVE` | yes | yes | success | 2026-09-02T00:28:51Z | **GREEN** | None |
| `adaptive-evidence-gap-gate.yml` | `ACTIVE` | no | no | success | 2026-08-28T20:06:33Z | **GREEN** | None |
| `adaptive-evidence-gap.yml` | `ACTIVE` | yes | yes | success | 2026-09-01T23:35:06Z | **GREEN** | None |
| `adaptive-gap-validation-gate.yml` | `ACTIVE` | no | no | success | 2026-08-26T14:16:58Z | **GREEN** | None |
| `adaptive-rotation-cadence.yml` | `ACTIVE` | yes | yes | success | 2026-09-02T07:06:58Z | **GREEN** | None |
| `api-agent-gateway-gate.yml` | `ACTIVE` | no | no | success | 2026-09-01T20:20:05Z | **GREEN** | None |
| `automation-production-health-gate.yml` | `ACTIVE` | no | no | success | 2026-09-01T20:40:34Z | **GREEN** | None |
| `automation-production-health.yml` | `ACTIVE` | yes | yes | in_progress | 2026-09-02T08:00:52Z | **GREEN** | None |
| `autonomous-research-governance-gate.yml` | `ACTIVE` | no | no | success | 2026-08-23T11:29:50Z | **GREEN** | None |
| `autonomous-research-governance-loop.yml` | `ACTIVE` | yes | yes | success | 2026-09-01T10:15:58Z | **GREEN** | None |
...
| `backtest-wave1-4-prospective.yml` | `ACTIVE` | yes | no | success | 2026-09-01T18:46:22Z | **GREEN** | None |
...
| `buildwithclaude-shadow-evidence-ledger.yml` | `ACTIVE` | yes | yes | success | 2026-08-31T01:33:14Z | **GREEN** | None |
| `buildwithclaude-shadow-prospective-observer.yml` | `ACTIVE` | no | no | success | 2026-08-23T15:24:40Z | **GREEN** | None |
| `buildwithclaude-shadow-round1.yml` | `ACTIVE` | no | no | failure | 2026-09-01T19:22:58Z | **RED** | REPEATED_CONSECUTIVE_FAILURES |
| `cfgi-recovery-launch-once.yml` | `ACTIVE` | no | no | success | 2026-08-23T07:25:36Z | **GREEN** | None |
| `cfgi-recovery-launch-trigger.yml` | `ACTIVE` | no | yes | skipped | 2026-09-02T05:56:21Z | **AMBER** | RECOVERING_AFTER_RECENT_FAILURES |
| `cfgi-v3-launch-receipt-publish.yml` | `ACTIVE` | no | yes | success | 2026-08-23T07:24:14Z | **GREEN** | None |
| `codex-intake-dispatch.yml` | `ACTIVE` | no | no | success | 2026-09-01T16:28:17Z | **GREEN** | None |
| `continuity-learning-gate.yml` | `ACTIVE` | no | no | success | 2026-09-02T05:56:04Z | **GREEN** | None |
| `continuity-learning-maintenance.yml` | `ACTIVE` | yes | yes | success | 2026-09-01T23:33:48Z | **GREEN** | None |
...
| `daily-capture-architecture-gate.yml` | `ACTIVE` | no | no | success | 2026-09-01T20:01:41Z | **GREEN** | None |
| `daily-director-shadow.yml` | `ACTIVE` | yes | yes | success | 2026-09-01T23:29:18Z | **GREEN** | None |
| `daily-machine-throughput-gate.yml` | `ACTIVE` | no | no | success | 2026-08-28T16:53:47Z | **GREEN** | None |
| `daily-machine-throughput.yml` | `ACTIVE` | yes | yes | success | 2026-09-02T00:35:09Z | **GREEN** | None |
| `daily-raw-owner-capture.yml` | `ACTIVE` | yes | yes | success | 2026-09-02T04:34:52Z | **GREEN** | None |
| `daily-settled-etf-calibration.yml` | `ACTIVE` | yes | yes | success | 2026-09-01T11:33:34Z | **GREEN** | None |
| `daily-slow-cycle-shadow.yml` | `ACTIVE` | yes | yes | success | 2026-09-01T09:34:21Z | **AMBER** | RECOVERING_AFTER_RECENT_FAILURES |
| `daily-stablecoin-liquidity.yml` | `ACTIVE` | yes | yes | success | 2026-09-01T10:13:53Z | **GREEN** | None |
| `data-architecture-gate.yml` | `ACTIVE` | no | no | success | 2026-09-02T05:56:04Z | **GREEN** | None |
| `data-terminal-shadow-manual.yml` | `ACTIVE` | no | no | success | 2026-09-01T20:10:32Z | **GREEN** | None |
| `dataset-registry-gate.yml` | `ACTIVE` | no | no | success | 2026-07-31T20:51:59Z | **GREEN** | None |
| `entry-signal-ledger-gate.yml` | `ACTIVE` | no | no | success | 2026-09-02T05:56:04Z | **GREEN** | None |
| `entry-signal-ledger.yml` | `ACTIVE` | yes | yes | success | 2026-09-02T05:08:49Z | **AMBER** | RECOVERING_AFTER_RECENT_FAILURES |
| `ethbtc-persistence-lifecycle.yml` | `ACTIVE` | no | yes | success | 2026-09-01T23:30:18Z | **GREEN** | None |
| `evidence-closure-gate.yml` | `ACTIVE` | no | no | success | 2026-09-01T20:10:32Z | **GREEN** | None |
| `evidence-lifecycle-observability-gate.yml` | `ACTIVE` | no | no | success | 2026-08-31T04:28:06Z | **GREEN** | None |
| `evidence-lifecycle-store-health.yml` | `ACTIVE` | yes | no | success | 2026-09-02T07:56:01Z | **GREEN** | None |
| `experiment-lifecycle-gate.yml` | `ACTIVE` | no | no | success | 2026-09-01T16:09:13Z | **GREEN** | None |
| `fetch_btc_d_cmc_free.yml` | `ACTIVE` | no | no | success | 2026-07-12T00:09:38Z | **GREEN** | None |
| `framework-learning-operations.yml` | `ACTIVE` | yes | yes | success | 2026-09-02T05:53:26Z | **GREEN** | None |
| `full-architecture-1to7-gate.yml` | `ACTIVE` | no | no | success | 2026-09-02T05:56:04Z | **GREEN** | None |
...
| `hourly-sequence-capture.yml` | `ACTIVE` | yes | yes | success | 2026-09-02T04:18:23Z | **GREEN** | None |
...
| `operations-dashboard.yml` | `ACTIVE` | yes | yes | success | 2026-09-01T19:13:12Z | **GREEN** | None |
| `operations-recovery-launch-once.yml` | `ACTIVE` | no | no | success | 2026-08-31T16:26:39Z | **GREEN** | None |
| `owner-bound-daily-director-manual.yml` | `ACTIVE` | no | no | success | 2026-09-01T20:20:05Z | **GREEN** | None |
...
| `pdlt-daily-census.yml` | `ACTIVE` | yes | yes | success | 2026-09-01T23:35:24Z | **AMBER** | RECOVERING_AFTER_RECENT_FAILURES |
| `pdlt-discovery-once.yml` | `EXPECTED_BLOCK` | no | no | failure | 2026-08-09T19:58:23Z | **AMBER** | EXPECTED_BLOCK |
| `pdlt-maturation.yml` | `ACTIVE` | yes | yes | success | 2026-09-02T00:19:38Z | **GREEN** | None |
...
| `pullback-learning-ledger.yml` | `ACTIVE` | yes | yes | success | 2026-09-02T06:27:57Z | **GREEN** | None |
| `remediation-maturation-gate.yml` | `ACTIVE` | no | no | success | 2026-08-31T00:58:50Z | **GREEN** | None |
| `remediation-maturation.yml` | `ACTIVE` | yes | yes | success | 2026-09-01T18:49:09Z | **GREEN** | None |
| `research-execution-coordinator.yml` | `ACTIVE` | yes | yes | success | 2026-09-01T21:43:56Z | **AMBER** | RECOVERING_AFTER_RECENT_FAILURES |
| `research-owner-breadth-daily.yml` | `ACTIVE` | yes | yes | success | 2026-09-01T10:07:52Z | **GREEN** | None |
| `research-owner-btcd-daily.yml` | `ACTIVE` | yes | yes | success | 2026-09-01T10:23:48Z | **GREEN** | None |
| `rich-breadth-checkpoint.yml` | `ACTIVE` | yes | yes | success | 2026-09-02T04:44:41Z | **GREEN** | None |
...
| `sequential-research-queue.yml` | `ACTIVE` | yes | yes | success | 2026-09-01T11:47:57Z | **GREEN** | None |
...
| `shadow-registry-gate.yml` | `ACTIVE` | no | no | success | 2026-09-01T20:40:34Z | **AMBER** | RECOVERING_AFTER_RECENT_FAILURES |
| `shadow-registry-weekly.yml` | `ACTIVE` | yes | yes | failure | 2026-09-01T20:31:05Z | **RED** | LATEST_RUN_FAILED |
| `shared-row-prospective-evidence-loop.yml` | `ACTIVE` | yes | yes | success | 2026-09-02T00:33:58Z | **GREEN** | None |
...
| `situation-room-daily-static.yml` | `ACTIVE` | yes | yes | success | 2026-09-01T16:30:26Z | **GREEN** | None |
...
| `source-provenance-recovery-loop.yml` | `ACTIVE` | yes | yes | success | 2026-09-01T09:50:42Z | **GREEN** | None |
| `specialist-architecture-gate.yml` | `ACTIVE` | no | no | success | 2026-08-23T11:29:50Z | **GREEN** | None |
| `storage-health-gate.yml` | `ACTIVE` | no | no | success | 2026-09-02T05:56:04Z | **GREEN** | None |
| `sunday-market-close-and-cfgi.yml` | `ACTIVE` | yes | yes | success | 2026-08-31T05:14:28Z | **AMBER** | RECOVERING_AFTER_RECENT_FAILURES |
| `top100-breadth-owner-manual.yml` | `ACTIVE` | no | no | success | 2026-09-01T20:10:32Z | **GREEN** | None |
...
## Blockers
- buildwithclaude-shadow-round1.yml:REPEATED_CONSECUTIVE_FAILURES
- shadow-registry-weekly.yml:LATEST_RUN_FAILED
...
- pdlt-daily-census.yml:RECOVERING_AFTER_RECENT_FAILURES
