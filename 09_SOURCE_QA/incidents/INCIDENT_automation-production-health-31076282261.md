...
Status: **RED**
Generated: `2026-08-06T06:08:19.392222Z`
Workflows: 40 local / 43 registered
Scheduled: 12
Writers: 11
GREEN / AMBER / RED: 31 / 6 / 3
...
| `automation-production-health-gate.yml` | no | no | success | 2026-08-05T17:54:57Z | **GREEN** | None |
| `automation-production-health.yml` | yes | yes | in_progress | 2026-08-06T06:08:11Z | **RED** | REPEATED_CONSECUTIVE_FAILURES |
...
| `continuity-learning-maintenance.yml` | yes | yes | success | 2026-08-05T22:42:15Z | **GREEN** | None |
| `daily-capture-architecture-gate.yml` | no | no | success | 2026-08-05T15:35:53Z | **GREEN** | None |
| `daily-director-shadow.yml` | yes | yes | success | 2026-08-05T22:31:05Z | **GREEN** | None |
| `daily-raw-owner-capture.yml` | yes | yes | success | 2026-08-05T22:17:27Z | **GREEN** | None |
| `data-architecture-gate.yml` | no | no | success | 2026-08-05T17:54:56Z | **GREEN** | None |
...
| `framework-learning-operations.yml` | yes | yes | success | 2026-08-06T04:32:34Z | **GREEN** | None |
| `full-architecture-1to7-gate.yml` | no | no | success | 2026-08-05T17:54:56Z | **GREEN** | None |
...
| `operations-dashboard.yml` | yes | yes | success | 2026-08-05T17:29:55Z | **GREEN** | None |
...
| `remediation-maturation.yml` | yes | yes | success | 2026-08-05T17:08:21Z | **GREEN** | None |
| `specialist-architecture-gate.yml` | no | no | success | 2026-08-01T05:33:29Z | **GREEN** | None |
| `storage-health-gate.yml` | no | no | success | 2026-08-05T17:54:57Z | **GREEN** | None |
