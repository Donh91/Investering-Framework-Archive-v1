...
Status: **RED**
Generated: `2026-08-09T15:55:32.943226Z`
Workflows: 48 local / 53 registered
Scheduled: 17
Writers: 16
GREEN / AMBER / RED: 37 / 7 / 4
...
| `automation-production-health-gate.yml` | no | no | success | 2026-08-09T15:52:11Z | **GREEN** | None |
| `automation-production-health.yml` | yes | yes | in_progress | 2026-08-09T15:55:27Z | **GREEN** | None |
| `backtest-engine-foundation.yml` | no | no | success | 2026-08-09T15:52:11Z | **AMBER** | RECOVERING_AFTER_RECENT_FAILURES |
| `backtest-readiness-contracts.yml` | no | no | success | 2026-07-30T18:08:16Z | **GREEN** | None |
| `backtest-wave1-2-foundation.yml` | no | no | success | 2026-08-09T15:52:11Z | **AMBER** | RECOVERING_AFTER_RECENT_FAILURES |
| `backtest-wave1-3-authority-lineage.yml` | no | no | success | 2026-07-28T16:15:15Z | **GREEN** | None |
| `backtest-wave1-4-prospective.yml` | yes | no | success | 2026-08-09T15:52:11Z | **GREEN** | None |
...
| `continuity-learning-gate.yml` | no | no | success | 2026-08-09T15:52:11Z | **GREEN** | None |
| `continuity-learning-maintenance.yml` | yes | yes | success | 2026-08-08T22:01:39Z | **GREEN** | None |
| `daily-capture-architecture-gate.yml` | no | no | success | 2026-08-09T15:52:11Z | **AMBER** | RECOVERING_AFTER_RECENT_FAILURES |
| `daily-director-shadow.yml` | yes | yes | success | 2026-08-08T21:50:23Z | **GREEN** | None |
| `daily-raw-owner-capture.yml` | yes | yes | failure | 2026-08-09T14:02:27Z | **RED** | LATEST_RUN_FAILED |
| `data-architecture-gate.yml` | no | no | success | 2026-08-09T15:52:11Z | **GREEN** | None |
...
| `experiment-lifecycle-gate.yml` | no | no | success | 2026-08-09T07:11:21Z | **GREEN** | None |
...
| `full-architecture-1to7-gate.yml` | no | no | success | 2026-08-09T15:52:11Z | **AMBER** | RECOVERING_AFTER_RECENT_FAILURES |
| `hourly-sequence-capture.yml` | yes | yes | success | 2026-08-09T10:16:57Z | **GREEN** | None |
...
| `operations-dashboard.yml` | yes | yes | success | 2026-08-09T05:10:14Z | **GREEN** | None |
...
| `remediation-maturation.yml` | yes | yes | success | 2026-08-09T04:50:53Z | **GREEN** | None |
...
| `storage-health-gate.yml` | no | no | success | 2026-08-09T15:52:11Z | **GREEN** | None |
