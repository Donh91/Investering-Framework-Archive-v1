...
Status: **RED**
Generated: `2026-09-21T20:03:59.477118Z`
Workflows: 178 local / 202 registered
Scheduled: 54
Writers: 58
GREEN / AMBER / RED: 149 / 23 / 6

## Workflow matrix
| Workflow | Lifecycle | Schedule | Writer | Last conclusion | Last run | Status | Findings |
|---|---|---:|---:|---|---|---|---|
| `adaptive-decision-miss-validation.yml` | `ACTIVE` | yes | yes | failure | 2026-09-21T00:27:10Z | **RED** | LATEST_RUN_FAILED, REPEATED_CONSECUTIVE_FAILURES |
| `adaptive-evidence-gap-gate.yml` | `ACTIVE` | no | no | success | 2026-09-13T11:09:41Z | **GREEN** | None |
| `adaptive-evidence-gap.yml` | `ACTIVE` | yes | yes | success | 2026-09-20T23:35:42Z | **GREEN** | None |
| `adaptive-gap-validation-gate.yml` | `ACTIVE` | no | no | success | 2026-08-26T14:16:58Z | **GREEN** | None |
| `adaptive-rotation-cadence.yml` | `ACTIVE` | yes | yes | success | 2026-09-21T16:28:29Z | **GREEN** | None |
| `alpha-arc-live-replay.yml` | `ACTIVE` | no | no | success | 2026-09-16T19:33:35Z | **GREEN** | None |
| `alpha-proof-supervisor.yml` | `ACTIVE` | no | no | success | 2026-09-21T19:30:19Z | **GREEN** | None |
| `alpha-shadow04-prospective.yml` | `ACTIVE` | yes | no | success | 2026-09-21T19:29:58Z | **AMBER** | SCHEDULE_WITHOUT_EXPLICIT_TIMEZONE |
| `api-agent-gateway-gate.yml` | `ACTIVE` | no | no | success | 2026-09-21T19:49:05Z | **GREEN** | None |
...
| `automation-production-health.yml` | `ACTIVE` | yes | yes | in_progress | 2026-09-21T20:03:45Z | **GREEN** | None |
...
| `backtest-wave1-4-prospective.yml` | `ACTIVE` | yes | no | success | 2026-09-20T18:16:40Z | **GREEN** | None |
...
| `compass-event-refresh.yml` | `ACTIVE` | yes | yes | success | 2026-09-21T17:13:05Z | **AMBER** | SCHEDULE_WITHOUT_EXPLICIT_TIMEZONE |
| `compass-outcomes.yml` | `ACTIVE` | yes | yes | success | 2026-09-21T19:39:49Z | **GREEN** | None |
| `compass-production-bootstrap.yml` | `ACTIVE` | no | no | success | 2026-09-19T09:16:17Z | **GREEN** | None |
| `compass-schedule-watchdog.yml` | `ACTIVE` | yes | no | success | 2026-09-21T14:29:53Z | **AMBER** | SCHEDULE_WITHOUT_EXPLICIT_TIMEZONE |
| `continuity-learning-gate.yml` | `ACTIVE` | no | no | success | 2026-09-21T19:49:05Z | **GREEN** | None |
| `continuity-learning-maintenance.yml` | `ACTIVE` | yes | yes | success | 2026-09-20T23:31:47Z | **GREEN** | None |
...
| `cycle-navigator-pages.yml` | `ACTIVE` | no | no | success | 2026-09-21T19:21:13Z | **GREEN** | None |
...
| `daily-compass.yml` | `ACTIVE` | yes | yes | success | 2026-09-21T19:20:46Z | **AMBER** | SCHEDULE_WITHOUT_EXPLICIT_TIMEZONE |
| `daily-director-shadow.yml` | `ACTIVE` | yes | yes | success | 2026-09-21T18:53:43Z | **GREEN** | None |
| `daily-machine-throughput-gate.yml` | `ACTIVE` | no | no | success | 2026-09-13T09:52:24Z | **GREEN** | None |
| `daily-machine-throughput.yml` | `ACTIVE` | yes | yes | success | 2026-09-21T00:34:27Z | **GREEN** | None |
| `daily-raw-owner-capture.yml` | `ACTIVE` | yes | yes | success | 2026-09-21T18:11:55Z | **GREEN** | None |
...
| `data-architecture-gate.yml` | `ACTIVE` | no | no | success | 2026-09-21T19:49:05Z | **GREEN** | None |
...
| `entry-signal-ledger.yml` | `ACTIVE` | yes | yes | success | 2026-09-21T17:12:48Z | **GREEN** | None |
| `ethbtc-persistence-lifecycle.yml` | `ACTIVE` | no | yes | success | 2026-09-21T18:54:54Z | **GREEN** | None |
...
| `evidence-lifecycle-store-health.yml` | `ACTIVE` | yes | no | success | 2026-09-21T08:58:56Z | **GREEN** | None |
...
| `framework-learning-operations.yml` | `ACTIVE` | yes | yes | failure | 2026-09-21T06:27:50Z | **RED** | LATEST_RUN_FAILED, REPEATED_CONSECUTIVE_FAILURES |
| `framework-learning-supervisor.yml` | `ACTIVE` | yes | yes | success | 2026-09-21T18:17:10Z | **AMBER** | RECOVERING_AFTER_RECENT_FAILURES |
...
| `hourly-sequence-capture.yml` | `ACTIVE` | yes | yes | success | 2026-09-21T19:18:07Z | **GREEN** | None |
...
| `meme-alpha-runtime-gate.yml` | `ACTIVE` | no | no | success | 2026-09-21T19:49:05Z | **GREEN** | None |
...
| `native-handlekompas.yml` | `ACTIVE` | yes | yes | success | 2026-09-21T19:45:11Z | **GREEN** | None |
| `native-market-recovery.yml` | `ACTIVE` | yes | yes | success | 2026-09-21T17:08:49Z | **GREEN** | None |
| `native-ota-research-readback.yml` | `ACTIVE` | yes | yes | success | 2026-09-21T05:31:48Z | **GREEN** | None |
...
| `operations-dashboard.yml` | `ACTIVE` | yes | yes | failure | 2026-09-21T09:47:00Z | **RED** | LATEST_RUN_FAILED, REPEATED_CONSECUTIVE_FAILURES |
| `operations-recovery-launch-once.yml` | `ACTIVE` | no | no | success | 2026-08-31T16:26:39Z | **GREEN** | None |
| `owner-bound-daily-director-manual.yml` | `ACTIVE` | no | no | success | 2026-09-21T19:49:05Z | **GREEN** | None |
...
| `provider-budget-readback.yml` | `ACTIVE` | no | yes | success | 2026-09-21T18:14:46Z | **GREEN** | None |
| `pullback-learning-gate.yml` | `ACTIVE` | no | no | failure | 2026-09-13T09:52:24Z | **AMBER** | PR_GATE_REJECTION, REPEATED_PR_GATE_REJECTIONS |
| `pullback-learning-ledger.yml` | `ACTIVE` | yes | yes | cancelled | 2026-09-21T17:12:52Z | **AMBER** | LATEST_RUN_CANCELLED |
| `remediation-maturation-gate.yml` | `ACTIVE` | no | no | success | 2026-09-16T00:25:47Z | **GREEN** | None |
| `remediation-maturation.yml` | `ACTIVE` | yes | yes | success | 2026-09-21T19:24:30Z | **GREEN** | None |
| `research-execution-coordinator.yml` | `ACTIVE` | yes | yes | success | 2026-09-21T13:59:02Z | **GREEN** | None |
...
| `rich-breadth-checkpoint.yml` | `ACTIVE` | yes | yes | success | 2026-09-21T15:09:27Z | **GREEN** | None |
...
| `shared-row-prospective-evidence-loop.yml` | `ACTIVE` | yes | yes | success | 2026-09-21T16:37:27Z | **GREEN** | None |
...
| `storage-health-gate.yml` | `ACTIVE` | no | no | success | 2026-09-21T19:49:05Z | **GREEN** | None |
