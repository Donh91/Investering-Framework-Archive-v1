...
Status: **RED**
Generated: `2026-08-10T05:01:27.090223Z`
Workflows: 49 local / 54 registered
Scheduled: 18
Writers: 17
GREEN / AMBER / RED: 38 / 9 / 2

## Workflow matrix
| Workflow | Schedule | Writer | Last conclusion | Last run | Status | Findings |
|---|---:|---:|---|---|---|---|
| `api-agent-gateway-gate.yml` | no | no | success | 2026-08-09T07:11:21Z | **GREEN** | None |
| `automation-production-health-gate.yml` | no | no | success | 2026-08-09T17:53:24Z | **GREEN** | None |
| `automation-production-health.yml` | yes | yes | in_progress | 2026-08-10T05:01:18Z | **GREEN** | None |
...
| `continuity-learning-gate.yml` | no | no | success | 2026-08-09T17:53:24Z | **GREEN** | None |
| `continuity-learning-maintenance.yml` | yes | yes | success | 2026-08-09T22:03:37Z | **GREEN** | None |
| `daily-capture-architecture-gate.yml` | no | no | success | 2026-08-09T17:53:24Z | **AMBER** | RECOVERING_AFTER_RECENT_FAILURES |
| `daily-director-shadow.yml` | yes | yes | success | 2026-08-09T21:53:27Z | **GREEN** | None |
| `daily-raw-owner-capture.yml` | yes | yes | success | 2026-08-09T21:43:54Z | **AMBER** | RECOVERING_AFTER_RECENT_FAILURES |
| `daily-settled-etf-calibration.yml` | yes | yes | none | none | **AMBER** | NO_RUN_HISTORY |
| `data-architecture-gate.yml` | no | no | success | 2026-08-09T20:12:25Z | **GREEN** | None |
...
| `experiment-lifecycle-gate.yml` | no | no | success | 2026-08-09T20:12:25Z | **GREEN** | None |
...
| `full-architecture-1to7-gate.yml` | no | no | success | 2026-08-09T17:53:24Z | **AMBER** | RECOVERING_AFTER_RECENT_FAILURES |
| `hourly-sequence-capture.yml` | yes | yes | success | 2026-08-10T02:32:34Z | **GREEN** | None |
...
| `operations-dashboard.yml` | yes | yes | success | 2026-08-09T16:34:06Z | **GREEN** | None |
| `owner-bound-daily-director-manual.yml` | no | no | success | 2026-08-09T07:11:21Z | **GREEN** | None |
...
| `pdlt-discovery-once.yml` | yes | yes | failure | 2026-08-09T19:58:23Z | **RED** | LATEST_RUN_FAILED, REPEATED_CONSECUTIVE_FAILURES |
...
| `remediation-maturation.yml` | yes | yes | success | 2026-08-09T16:02:30Z | **GREEN** | None |
| `sequential-research-queue.yml` | yes | yes | success | 2026-08-09T07:27:08Z | **GREEN** | None |
| `specialist-architecture-gate.yml` | no | no | success | 2026-08-01T05:33:29Z | **GREEN** | None |
| `storage-health-gate.yml` | no | no | success | 2026-08-09T20:12:25Z | **GREEN** | None |
...
| `weekly-api-calibration-shadow.yml` | yes | yes | failure | 2026-08-10T02:38:25Z | **RED** | LATEST_RUN_FAILED, REPEATED_CONSECUTIVE_FAILURES |
