...
const checks=[
 ...
 ['latest completed precision keeps canonical score primary',weeklyWidget.includes('Latest completed precision')&&weeklyWidget.includes('Canonical Cycle Navigator scorecard')&&weeklyWidget.includes('public-continuity scores remain separate')],
 ['reconciled range score remains supplemental',weeklyWidget.includes('snapshot?.range_score')&&weeklyWidget.includes('Recovered price-range record')&&weeklyWidget.includes('does not replace or alter the current canonical CN scorecard')],
